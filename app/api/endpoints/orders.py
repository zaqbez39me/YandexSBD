...
from app.api.dependencies.orders import get_order_by_id, get_orders_in_range, add_orders, complete_order
...
async def get_order_by_id(
        order: OrderDto = Depends(get_order_by_id)
):
    return order
...
async def add_orders(
        orders_dto: list[OrderDto] = Depends(add_orders)
):
    return orders_dto
